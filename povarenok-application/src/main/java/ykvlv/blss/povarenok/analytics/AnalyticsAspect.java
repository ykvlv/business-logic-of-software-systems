...
public class AnalyticsAspect {
	...
	@AfterReturning("execution(* ykvlv.blss.povarenok.service.ClientService.create(..))")
	private void countRegistration() {
		registerCount.incrementAndGet();
	}

	@AfterReturning("execution(* ykvlv.blss.povarenok.service.ClientService.likeRecipe(..))")
	private void countLike() {
		likeCount.incrementAndGet();
	}

	@AfterReturning("execution(* ykvlv.blss.povarenok.service.RecipeService.create(..))")
	private void countAddRecipe() {
		addRecipeCount.incrementAndGet();
	}

	@AfterReturning("execution(* ykvlv.blss.povarenok.service.ReviewService.create(..))")
